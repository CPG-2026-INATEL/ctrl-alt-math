...
STRINGS = {
    ...
    "lobby_enter_ip": {LANG_EN: "Enter host address or tcp://host:port:", LANG_PT: "Digite o endereco do host ou tcp://host:porta:"},
    "lobby_scan_hint": {LANG_EN: "Ctrl+S to scan LAN", LANG_PT: "Ctrl+S para escanear LAN"},
    "lobby_join_help": {LANG_EN: "Type an IP, host:port, or tcp://host:port. LAN scan also works.", LANG_PT: "Digite IP, host:porta ou tcp://host:porta. O escaneamento LAN tambem funciona."},
